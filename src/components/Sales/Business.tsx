...
import { MessageCircle, ShoppingCart, TrendingUp, Clock, ArrowRight } from 'lucide-react'
...
function Business() {
  const businessCards = [
    ...
    },
    {
      ...
      descriptionText: 'text-purple-500',
            ...
            return (
              ...
              >
                ...
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <h3 className={`text-2xl font-bold ${card.titleText}`}>
                    {card.title}
                  </h3>
                </div>

                {/* Description */}
                <p className={`${card.descriptionText} mb-6 text-lg`}>
                  {card.description}
                </p>
