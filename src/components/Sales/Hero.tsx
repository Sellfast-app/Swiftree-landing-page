        ...
        <div className="text-center mb-12">
          ...
          >
            <a href="#partners" className="flex items-center">
                        <span className="rounded-full bg-[#4FCA6A] text-white p-2 flex items-center gap-1 mr-2"><span className="rounded-full bg-[#628055] "><Circle className="h-2 w-2 bg-white rounded-full text-center"/></span> Limited-Time Offer</span>
                        Get <span className="text-[#4FCA6A]">20% off</span> when you sign up today <ArrowRight className="ml-2 h-5 w-5" />
            </a>
          </Badge>
